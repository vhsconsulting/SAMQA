   ...
   ORGANIZATION EXTERNAL 
    ( TYPE ORACLE_LOADER
      ...
      ( records delimited BY newline skip 1 
        ...
        badfile'GP_PAYMENT_ERROR_EXTERNAL.bad'  logfile'GP_PAYMENT_ERROR_EXTERNAL.log'
          )
      LOCATION
