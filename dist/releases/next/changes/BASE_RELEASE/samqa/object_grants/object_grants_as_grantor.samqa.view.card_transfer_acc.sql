...
-- changeset SAMQA:1753779566039 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.samqa.view.card_transfer_acc.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
