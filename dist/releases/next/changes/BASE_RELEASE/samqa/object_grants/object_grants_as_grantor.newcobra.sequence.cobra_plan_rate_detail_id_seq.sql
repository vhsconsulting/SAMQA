...
-- changeset SAMQA:1753779550224 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.newcobra.sequence.cobra_plan_rate_detail_id_seq.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
