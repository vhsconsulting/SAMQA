...
-- changeset SAMQA:1753779566543 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.samqa.view.en_type.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
