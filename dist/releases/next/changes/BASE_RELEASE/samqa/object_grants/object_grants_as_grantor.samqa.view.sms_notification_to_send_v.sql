...
-- changeset SAMQA:1753779567646 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.samqa.view.sms_notification_to_send_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
