...
-- changeset SAMQA:1753779694107 stripComments:false logicalFilePath:BASE_RELEASE\samqa\package_bodies\pc_sales_team.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/package_bodies/pc_sales_team.sql:null:cfefeb18a66b44e50102477033529c23c92df29c:create
      ...
      -- Added by Joshi for 5022. same sales team member can parimary/secondary role.
        ...
        if l_same_sls_count = 0 then
            ...
            px_sales_team_member_id := l_sales_team_member_id;
					...
					-- hari added for cobra welcome letters 06/09/2025 
