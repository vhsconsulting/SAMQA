...
-- changeset SAMQA:1753779707641 stripComments:false logicalFilePath:BASE_RELEASE\samqa\package_bodies\pc_user_bank_acct.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/package_bodies/pc_user_bank_acct.sql:null:179ab835caad60ec7c431fb401911abb3e8f4e91:create
   ...
   -- For FSA/HRA its applicable for employer and employee
            if nvl(l_account_status, 0) <> 1 then
                ...
                if (
                    ...
                    v_account_status := '3';
                elsif ( l_account_type in ( 'HRA', 'FSA', 'COBRA', 'FORM_5500', 'POP' ) ) then  -- POP added 12675 -- FORM_5500 Added by Swamy for Ticket#12527
