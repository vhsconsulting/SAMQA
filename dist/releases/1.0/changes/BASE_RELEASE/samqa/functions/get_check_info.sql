...
-- changeset SAMQA:1754373927338 stripComments:false logicalFilePath:BASE_RELEASE\samqa\functions\get_check_info.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/functions/get_check_info.sql:null:5656b9075cbc59ff225ee65d61b547288a025fef:create
