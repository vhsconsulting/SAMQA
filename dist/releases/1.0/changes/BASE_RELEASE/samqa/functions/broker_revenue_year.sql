...
-- changeset SAMQA:1754373927002 stripComments:false logicalFilePath:BASE_RELEASE\samqa\functions\broker_revenue_year.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/functions/broker_revenue_year.sql:null:d59387bf1368a85566416f192a69a40fcb8e19d3:create
