...
-- changeset SAMQA:1753779763572 stripComments:false logicalFilePath:BASE_RELEASE\samqa\synonyms\cobra_plan_rate_detail_id_seq.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
