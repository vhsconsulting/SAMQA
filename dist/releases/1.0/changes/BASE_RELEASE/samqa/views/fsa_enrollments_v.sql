...
-- changeset SAMQA:1754374173896 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\fsa_enrollments_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/fsa_enrollments_v.sql:null:2ed672829f2e955a98cdd2428318500e832f7312:create

create or replace force editionable view samqa.fsa_enrollments_v (
    enrollment_type,
    ryear,
    rmonth,
    rmm,
