...
-- changeset SAMQA:1754374179009 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\subscriber_hra_welcome_letter.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/subscriber_hra_welcome_letter.sql:null:cc467aec187fe86cac7bfb243effefa069f39bc7:create

create or replace force editionable view samqa.subscriber_hra_welcome_letter (
    today,
    person_name,
    address,
    city,
