...
-- changeset SAMQA:1754374170947 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\cobra_renewal_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/cobra_renewal_v.sql:null:a90a29f24cbd04c0761d8e5f85c6698868f0a76e:create
