...
-- changeset SAMQA:1754374176202 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\incident_file_attachments_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/incident_file_attachments_v.sql:null:b558c4ba19a0dc3afb9f2135392934624ce5e35f:create
