...
-- changeset SAMQA:1754374175938 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\hrafsa_future_claim_letters_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/hrafsa_future_claim_letters_v.sql:null:bad4df01cd9abc110231e35c0726d51003e0eb41:create
