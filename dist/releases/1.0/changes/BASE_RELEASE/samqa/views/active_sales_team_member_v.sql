...
-- changeset SAMQA:1753779779475 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\active_sales_team_member_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
