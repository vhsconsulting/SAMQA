...
-- changeset SAMQA:1754374171490 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\debit_card_letter_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/debit_card_letter_v.sql:null:cd21e9cc0dfea5facdffb02ea966e38417583714:create
