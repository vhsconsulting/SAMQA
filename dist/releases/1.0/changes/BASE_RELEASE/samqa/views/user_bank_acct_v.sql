...
-- changeset SAMQA:1754374180134 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\user_bank_acct_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/user_bank_acct_v.sql:null:1bf9badbe5a8d5e6ff196defcdf0e9be40a79c67:create
