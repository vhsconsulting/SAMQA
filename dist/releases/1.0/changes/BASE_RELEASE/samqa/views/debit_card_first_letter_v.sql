...
-- changeset SAMQA:1754374171419 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\debit_card_first_letter_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/debit_card_first_letter_v.sql:null:b86303039dee8add551899bc45300b61463595a6:create
