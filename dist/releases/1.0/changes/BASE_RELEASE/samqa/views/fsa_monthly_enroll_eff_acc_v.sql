...
-- changeset SAMQA:1754374174669 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\fsa_monthly_enroll_eff_acc_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/fsa_monthly_enroll_eff_acc_v.sql:null:34c36638b87ec16bc3cf51d68daecebc3fd1d351:create

create or replace force editionable view samqa.fsa_monthly_enroll_eff_acc_v (
    acc_year,
    acc_month,
    mm,
    active,
    ...
    from
        (
            select
                to_char(start_date, 'YYYY') acc_year,
                to_char(start_date, 'MON')  acc_month,
                to_char(start_date, 'MM')   mm,
                count(*)                    active,
                0                           continuing
            from
                account a,
