...
-- changeset SAMQA:1754374179798 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\template_subscrib_hra_wel_mail.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/template_subscrib_hra_wel_mail.sql:null:608de0b1310bf981e5a60682695d6c248fe0d6aa:create

create or replace force editionable view samqa.template_subscrib_hra_wel_mail (
    today,
    person_name,
    address,
    city,
    ...
    --AND A.EMAIL             IS NOT NULL
                ...
                and d.account_type = b.account_type
