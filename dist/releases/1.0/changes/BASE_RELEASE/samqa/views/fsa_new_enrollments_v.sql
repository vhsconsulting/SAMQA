...
-- changeset SAMQA:1754374174779 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\fsa_new_enrollments_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/fsa_new_enrollments_v.sql:null:0ccc5335325adeb2ced7db5a25824145627fdcb9:create
