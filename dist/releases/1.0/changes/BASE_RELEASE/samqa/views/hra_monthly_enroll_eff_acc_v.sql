...
-- changeset SAMQA:1754374175426 stripComments:false logicalFilePath:BASE_RELEASE\samqa\views\hra_monthly_enroll_eff_acc_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/views/hra_monthly_enroll_eff_acc_v.sql:null:65f77509cd9d25928ef487552454b9ef28487d01:create

create or replace force editionable view samqa.hra_monthly_enroll_eff_acc_v (
    acc_year,
    acc_month,
    mm,
    active,
