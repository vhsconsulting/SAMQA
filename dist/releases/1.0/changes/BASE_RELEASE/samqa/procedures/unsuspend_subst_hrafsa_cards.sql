...
-- changeset SAMQA:1754374146621 stripComments:false logicalFilePath:BASE_RELEASE\samqa\procedures\unsuspend_subst_hrafsa_cards.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/procedures/unsuspend_subst_hrafsa_cards.sql:null:cd5a451b1d323430b24c3d4ed3100b1a63e76464:create

create or replace procedure samqa.unsuspend_subst_hrafsa_cards is
begin
...
end unsuspend_subst_hrafsa_cards;
/
