...
-- changeset SAMQA:1754374150975 stripComments:false logicalFilePath:BASE_RELEASE\samqa\tables\account_flashback.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/tables/account_flashback.sql:null:10fcb6ded8cf65badbc1259d9b52708974ba73ca:create

create table samqa.account_flashback (
