...
-- changeset SAMQA:1754374163575 stripComments:false logicalFilePath:BASE_RELEASE\samqa\tables\sys_export_schema_02.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/tables/sys_export_schema_02.sql:null:91b0bcb7bd64d3905b31ff7c8a27b24c03c1bf41:create

create table samqa.sys_export_schema_02 (
    abort_step              number,
