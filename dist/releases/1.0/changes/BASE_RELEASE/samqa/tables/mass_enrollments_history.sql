...
-- changeset SAMQA:1754374160419 stripComments:false logicalFilePath:BASE_RELEASE\samqa\tables\mass_enrollments_history.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/tables/mass_enrollments_history.sql:null:8fc7070d644d669636fa0dadb2ebdedc2a5cf515:create

create table samqa.mass_enrollments_history (
    mass_enroll_history_id   number,
    ...
    error_column             varchar2(255 byte),
    entrp_id                 number,
