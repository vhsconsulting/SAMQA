...
-- changeset SAMQA:1753779563352 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.samqa.table.external_sales_team_leads.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
