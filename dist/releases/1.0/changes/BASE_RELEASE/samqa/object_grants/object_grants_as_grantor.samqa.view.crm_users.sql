...
-- changeset SAMQA:1753779566270 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.samqa.view.crm_users.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
