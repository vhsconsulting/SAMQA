...
-- changeset SAMQA:1753779567540 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.samqa.view.plb_users_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
