...
-- changeset SAMQA:1753779567102 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.samqa.view.incident_file_attachments_v.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
