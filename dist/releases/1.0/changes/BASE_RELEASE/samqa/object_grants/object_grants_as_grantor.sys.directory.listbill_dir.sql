...
-- changeset SAMQA:1753779792521 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.sys.directory.listbill_dir.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
