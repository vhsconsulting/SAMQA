...
-- changeset SAMQA:1753779561755 stripComments:false logicalFilePath:BASE_RELEASE\samqa\object_grants\object_grants_as_grantor.samqa.table.aop_config.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
