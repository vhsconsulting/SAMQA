...
-- changeset SAMQA:1753779555166 stripComments:false logicalFilePath:BASE_RELEASE\samqa\indexes\expense_id_pk.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
