...
-- changeset SAMQA:1754373935025 stripComments:false logicalFilePath:BASE_RELEASE\samqa\materialized_views\broker_account_rnw_rev_5yr.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/materialized_views/broker_account_rnw_rev_5yr.sql:null:0eac80b75faef1f3c923244c660a67a6d4d86aa3:create

create materialized view samqa.broker_account_rnw_rev_5yr (
    "0",
    year,
    cnt
            ...
            from
                (
                    select
                        *
                    from
                        broker_account_nohsa_rnw_rev_mv
                    where
