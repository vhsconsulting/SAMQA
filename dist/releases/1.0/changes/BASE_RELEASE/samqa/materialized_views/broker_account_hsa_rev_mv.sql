...
-- changeset SAMQA:1754373933705 stripComments:false logicalFilePath:BASE_RELEASE\samqa\materialized_views\broker_account_hsa_rev_mv.sql runAlways:false runOnChange:false replaceIfExists:true failOnError:true
-- sqlcl_snapshot src/database/samqa/materialized_views/broker_account_hsa_rev_mv.sql:null:f79225cb3caba6583dd92ec7502f7feaf52962c2:create
